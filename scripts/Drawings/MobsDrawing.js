export class MobsDrawing extends DrawingUtils {
  ...
  invalidate(ctx, mobs, mists) {
    for (const mobOne of mobs) {
      ...
      if (
        mobOne.type == 0 ||
        (mobOne.type == 1 && !this.settings.mobTiers[mobOne.tier - 1])
      ) {
        continue;
      }
      // }
      ...
      if (mobOne.type == 1) {
        this.drawImageCustom(
          ctx,
          point.x,
          point.y,
          "hide_" + mobOne.tier + "_" + mobOne.enchantmentLevel,
          40
        );
        ...
        if (myString.includes("wood")) {
          this.drawImageCustom(
            ...
            point.x,
            point.y,
            "Logs_" + mobOne.tier + "_" + mobOne.enchantmentLevel,
            40
          );
        } else {
          this.drawImageCustom(
